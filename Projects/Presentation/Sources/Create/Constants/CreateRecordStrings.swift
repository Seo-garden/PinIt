...
enum CreateRecordStrings {
    ...
    static let saveSuccessTitle = NSLocalizedString("record.alert.saveSuccess.title", value: "저장", comment: "")
    static let saveSuccessMessage = NSLocalizedString("record.alert.saveSuccess.message", value: "저장 성공", comment: "")
